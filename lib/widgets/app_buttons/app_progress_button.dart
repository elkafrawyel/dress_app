...
class AppProgressButtonState extends State<AppProgressButton> with TickerProviderStateMixin {
      ...
      builder: (context, child) => Container(
        ...
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(
            ...
            backgroundColor: widget.backgroundColor ?? Theme.of(context).primaryColor, //background color
            shape: RoundedRectangleBorder(borderRadius: radiusAnimation.value!),
          ),
          onPressed: () async {
            try {
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: GetPlatform.isIOS
                            ? CupertinoActivityIndicator(color: widget.textColor ?? Colors.black)
