    ...
    transitionBuilder: (ctx, a1, a2, child) {
      ...
      return Transform.scale(
        ...
        child: AlertDialog(
          ...
          insetPadding: EdgeInsets.symmetric(horizontal: horizontalMargin, vertical: 12.0),
          contentPadding: contentPadding,
          actions: <Widget>[
      ...
      return Transform.scale(
        ...
        child: GetPlatform.isIOS
            ? CupertinoAlertDialog(
                title: AppText(title, fontWeight: FontWeight.w900, fontSize: 18),
                content: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: AppText(body, fontWeight: FontWeight.w500, fontSize: 14),
                ),
                actions: [
                  if (onConfirmClick != null)
                    TextButton(
            ...
            : AlertDialog(
                title: AppText(title, fontWeight: FontWeight.w900, fontSize: 18),
                content: AppText(body, fontWeight: FontWeight.w500, fontSize: 14),
