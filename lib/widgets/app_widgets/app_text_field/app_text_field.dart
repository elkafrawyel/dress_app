...
class AppTextFormFieldState extends State<AppTextFormField> {
  ...
  void initState() {
    super.initState();
    _isPasswordField =
        AppFieldType.password == widget.appFieldType || AppFieldType.confirmPassword == widget.appFieldType;
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: widget.horizontalPadding ?? 8.0, vertical: 4.0),
                ...
                TextFormField(
                  ...
                  validator: (String? value) {
                    if (!widget.required) {
                      ...
                      return !widget.required ? null : (widget.validateEmptyText ?? 'field_required'.tr);
                    } else {
                      return null;
                    }
                  },
                  ...
                  decoration: InputDecoration(
                    helperText: (_helperText?.isEmpty ?? true) ? null : _helperText,
                    helperMaxLines: 4,
                    helperStyle: const TextStyle(color: errorColor, fontSize: 13, fontWeight: FontWeight.w500),
                    labelText: widget.showLabel! ? widget.labelText : null,
                    labelStyle: Theme.of(context).textTheme.titleSmall!.copyWith(fontFamily: fontFamily),
                    ...
                    prefixIcon: widget.prefixIcon != null ? Icon(widget.prefixIcon, size: 20, color: iconColor) : null,
                    ...
                    errorBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(widget.radius ?? kRadius),
                      borderSide: BorderSide(width: kSelectedBorderWidth, color: errorColor),
                    ),
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(widget.radius ?? kRadius),
                      borderSide: BorderSide(width: kSelectedBorderWidth, color: borderColor),
                    ),
                  ),
                ),
